...
from objects import Base, Flashcard  # Adjust the import according to your project structure
...
# NOTETYPE = "Basic (and reversed) with pronunciation"
# fcs = retrieve_flashcards_from_database("/ankigarden.db")
# anki_str = create_anki_import_string(fcs,
                           ...
                           # COLUMNS,
                           # NOTETYPE)
# create_anki_import_file(anki_str, "prompts-result.txt")
